...
public class OnDiskFileSystemTest : BaseUnitTestCase
{
    ...
    {
        _target = new DiskFileSystem(RootDir);
    }
    ...
    {
        // Act
        await _target.CreateVolumeAsync("testVolume1");

        // Assert
        Assert.True(Directory.Exists(Path.Join(RootDir, "testVolume1")));

        // Act
        await _target.DeleteVolumeAsync("testVolume1");
    ...
    {
        // Act
        await _target.CreateVolumeAsync("testVolume2");

        // Assert
        Assert.True(await _target.VolumeExistsAsync("testVolume2"));

        // Cleanup
        await _target.DeleteVolumeAsync("testVolume2");
    }
