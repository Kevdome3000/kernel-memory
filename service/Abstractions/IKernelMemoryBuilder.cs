...
public interface IKernelMemoryBuilder
{
    ...
    /// </summary>
    ServiceCollectionPool Services { get; }
    ...
    IKernelMemory Build(KernelMemoryBuilderBuildOptions? options = null);
    ...
    /// <param name="options">Options for the build process</param>
    /// <returns>A memory instance</returns>
    T Build<T>(KernelMemoryBuilderBuildOptions? options = null) where T : class, IKernelMemory;
    ...
    IKernelMemoryBuilder AddSingleton<TService>(TService implementationInstance)
    ...
    IKernelMemoryBuilder AddSingleton<TService, TImplementation>()
        where TService : class
    ...
    /// </summary>
    IKernelMemoryBuilder WithoutDefaultHandlers();
    ...
    IKernelMemoryBuilder AddIngestionMemoryDb(IMemoryDb service);
    ...
    IKernelMemoryBuilder AddIngestionEmbeddingGenerator(ITextEmbeddingGenerator service);


    /// <summary>
    /// Return an instance of the pipeline orchestrator, usually required by custom handlers.
    /// </summary>
    IPipelineOrchestrator GetOrchestrator();
}
