...
public sealed class InfixQueryParserTests
{
    ...
    public void Parse_SimpleTextSearch_ReturnsTextSearchNode()
    {
        ...
        var result = _parser.Parse("kubernetes");
    ...
    {
        var result = _parser.Parse("\"machine learning\"");
    ...
    {
        var result = _parser.Parse("tags==production");
    ...
    {
        var result = _parser.Parse("mimeType!=image/png");
    ...
    {
        var result = _parser.Parse("createdAt<2024-02-01");
    ...
    {
        var result = _parser.Parse("content:~\"machine learning\"");
    ...
    {
        var result = _parser.Parse("tags:[AI,ML,research]");
    ...
    {
        var result = _parser.Parse("kubernetes AND docker");
    ...
    {
        var result = _parser.Parse("kubernetes OR docker");
    ...
    {
        var result = _parser.Parse("NOT kubernetes");
    ...
    {
        var result = _parser.Parse("(tags:AI OR tags:ML) AND NOT mimeType:image/png");
    ...
    {
        var result = _parser.Parse("createdAt>=2024-01-01 AND createdAt<2024-02-01");
    ...
    {
        var result = _parser.Parse("kubernetes AND tags:production");
    ...
    {
        var result = _parser.Parse("((tags:AI OR tags:ML) AND content:kubernetes) OR tags:docker");
    ...
    {
        Assert.Throws<QuerySyntaxException>(() => _parser.Parse("(kubernetes AND docker"));
        Assert.Throws<QuerySyntaxException>(() => _parser.Parse("kubernetes AND docker)"));
    }
    ...
    {
        Assert.True(_parser.Validate("kubernetes"));
        Assert.True(_parser.Validate("content:kubernetes AND tags:AI"));
        Assert.True(_parser.Validate("(A OR B) AND NOT C"));
    }
    ...
    public void Validate_InvalidQuery_ReturnsFalse()
    {
        ...
        Assert.False(_parser.Validate("(unmatched"));
    }
    ...
    {
        var result = _parser.Parse("metadata.author:John AND metadata.department:AI");
    ...
    public void Parse_OperatorPrecedence_NotHigherThanAnd()
    {
        ...
        var result = _parser.Parse("kubernetes AND NOT docker");
    ...
    {
        var result = _parser.Parse("content:\"test:value with:colons\"");
    ...
    public void Parse_QuotedPhraseContainingAND_ReturnsTextSearchNode()
    {
        ...
        var result = _parser.Parse("\"Alice AND Bob\"");
    ...
    {
        // Issue #4: Quoted phrases containing reserved words should be literal
        var result = _parser.Parse("\"this OR that\"");
    ...
    {
        // Issue #4: Quoted phrases containing reserved words should be literal
        var result = _parser.Parse("\"this is NOT important\"");
    ...
    public void Parse_QuotedReservedWordWithBooleanOperator_ReturnsLogicalNode()
    {
        ...
        var result = _parser.Parse("\"NOT\" AND kubernetes");
    ...
    public void Parse_FieldWithQuotedReservedWordValue_ReturnsComparisonNode()
    {
        ...
        var result = _parser.Parse("content:\"NOT\"");
    ...
    public void Parse_FieldContainsWithQuotedReservedPhrase_ReturnsComparisonNode()
    {
        ...
        var result = _parser.Parse("content:~\"Alice AND Bob\"");
    ...
    public void Parse_ComplexQueryWithQuotedReservedWords_ReturnsCorrectAST()
    {
        ...
        var result = _parser.Parse("\"AND\" OR \"OR\" AND \"NOT\"");
    ...
    public void Parse_MixedCaseQuotedReservedWords_ReturnsTextSearchNode()
    {
        ...
        var result = _parser.Parse("\"And Or Not\"");
