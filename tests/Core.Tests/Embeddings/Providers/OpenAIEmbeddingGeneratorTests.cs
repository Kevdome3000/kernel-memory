...
public sealed class OpenAIEmbeddingGeneratorTests
{
    ...
    {
        _loggerMock = new Mock<ILogger<OpenAIEmbeddingGenerator>>();
        ...
        _httpHandlerMock
            ...
            .Setup<Task<HttpResponseMessage>>(
                ...
                ItExpr.Is<HttpRequestMessage>(req =>
                    req.Method == HttpMethod.Post && req.RequestUri!.ToString() == "https://api.openai.com/v1/embeddings"),
    ...
    public async Task GenerateAsync_Batch_WithSmallBatchSize_ShouldChunkRequests()
    {
        ...
        _httpHandlerMock
            ...
            .Returns<HttpRequestMessage, CancellationToken>(async (req, ct) =>
            {
                ...
                var response = CreateOpenAIResponseWithTokenCount(embeddings, 3);
    ...
    public void Constructor_WithNullApiKey_ShouldThrow()
    {
        ...
        Assert.Throws<ArgumentNullException>(() =>
            new OpenAIEmbeddingGenerator(httpClient,
                null!,
                "model",
                1536,
                true,
    ...
    {
        // Arrange
        var response = CreateOpenAIResponseWithTokenCount(new[] { new[] { 0.1f, 0.2f, 0.3f } }, 42);
        var responseJson = JsonSerializer.Serialize(response);
    ...
    {
        return CreateOpenAIResponseWithTokenCount(embeddings, 10);
    }
